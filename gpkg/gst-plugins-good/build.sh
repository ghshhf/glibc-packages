...
TERMUX_PKG_DEPENDS="glibc, gstreamer-glibc, gst-plugins-base-glibc, libsoup-glibc, libpng-glibc, libjpeg-turbo-glibc, speex-glibc, cairo-glibc, pango-glibc, alsa-lib-glibc, gnutls-glibc, flac-glibc, libvpx-glibc"
TERMUX_PKG_BUILD_DEPENDS="meson, ninja, pkg-config, gstreamer-glibc-dev, gst-plugins-base-glibc-dev"
